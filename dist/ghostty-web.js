...
const j = {
  ...
  extractModifiers(A) {
    let Q = n.NONE;
    return A.shiftKey && (Q |= n.SHIFT), A.ctrlKey && (Q |= n.CTRL), A.altKey && (Q |= n.ALT), A.metaKey && (Q |= n.SUPER), Q;
  }
  /**
...
const d = class Y {
  ...
  provideLinks(A, Q) {
    ...
    for (; I !== null; ) {
      ...
      const s = D.replace(Y.TRAILING_PUNCTUATION, "");
